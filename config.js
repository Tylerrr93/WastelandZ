...
worldGen: {
  ...
  rivers: {
      enabled: true,
      count: 10,           // Number of river sources
      minLength: 15,       // Discard rivers shorter than this
      widenAtMouth: true,  // Rivers get wider near large water bodies
  },

  /* ── Noise Settings (NEW - replaces sin/cos) ─────────────── */
  noise: {
      scale: 20,           // Zoom level (higher = larger biomes)
      octaves: 3,          // Detail level
      waterLevel: 0.35,    // < 0.35 = Water
      forestLevel: 0.65,   // > 0.65 = Forest
  },
